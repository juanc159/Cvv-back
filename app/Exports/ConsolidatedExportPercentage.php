...
class ConsolidatedExportPercentage implements WithMultipleSheets
{
    use Exportable;
    ...
    public function sheets(): array
    {
        ...
        foreach ($groupedStudentsArray as $key => $value) {
            ...
            // if ($key === 'Primer Grado') {
                ...
                // logMessage("ConsolidatedExport: Skipping Primer Grado grade");
                // continue; // O manejarlo de otra manera si es necesario

            // }
            $sheets[] = new StudentPercentageExport($this->headers[$key], $value, $key, $this->type_education_id);
        }
