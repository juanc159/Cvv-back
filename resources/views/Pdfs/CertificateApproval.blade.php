        ...
        <div class="content-container">
            <table class="title-container">
                <tr>
                    <td colspan="2" style="text-align: center">
                        <b>
                            <label class="title">CONSTANCIA DE APROBACIÓN</label>
                        </b>
                    </td>
                </tr>
            </table>
            ...
            <div class="indented-text">
                <p>
                    ...
                    cursó y aprobó en esta institución el
                    <strong>{{ mb_strtoupper($data['student']['grade']['name'], 'UTF-8') }} DE
                        {{ mb_strtoupper($data['student']['type_education']['name'], 'UTF-8') }}</strong>, en el
