        ...
        <div class="content-container">
            <table class="title-container">
                <tr>
                    <td colspan="2" style="text-align: center">
                        <b>
                            <label class="title">CONSTANCIA DE CONDUCTA</label>
                        </b>
                    </td>
                </tr>
            </table>
            ...
            <div class="indented-text">
                <p>
                    ...
                    {{ mb_strtoupper($data['student']['type_education']['name'], 'UTF-8') }}, en el
                    {{ strtolower($data['term']['name']) }}, demostró durante ese tiempo BUENA CONDUCTA.
                </p>
                <p>
