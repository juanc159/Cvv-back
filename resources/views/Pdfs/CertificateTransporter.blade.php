        ...
        <div class="content-container">
            <table class="title-container">
                <tr>
                    <td colspan="2" style="text-align: center">
                        <b>
                            <label class="title">CONSTANCIA DE TRANSPORTISTA</label>
                        </b>
                    </td>
                </tr>
            </table>
            ...
            <div class="indented-text">
                <p>
                    ...
                    cédula de identidad
                    N° {{ $data['additionalInfo']['documentType'] }}-{{ $data['additionalInfo']['documentNumber'] }}

                    realiza TRANSPORTE ESCOLAR para esta Institucion, para el {{ strtolower($data['term']['name']) }}.
                </p>
                <p>
