...
<head>
    ...
    <style>
        ...
        * {
        ...
        body {
            /* Debe ir siempre igual que header{height}: es el espacio que el
               body deja libre para no pisar el header, que es position:fixed. */
            margin-top: 4.5cm;
            margin-left: 0cm;
            margin-right: 0cm;
            margin-bottom: 3cm;
        ...
        header {
            ...
            left: 0cm;
            right: 0cm;
            /* Alto real del contenido, medido sobre el PDF: el escudo termina
               en 5.10cm. Con los 4cm de antes se montaba encima del título. */
            height: 4.5cm;
            display: flex;
            flex-direction: column;
            align-items: center;
        ...
        footer {
            ...
            left: 0cm;
            right: 0cm;
            /* Picture2 es 794x107px: a ancho completo de pagina (21cm) mide
               2.83cm de alto. Entra en los 3cm que el body reserva abajo. */
            height: 2.83cm;
            text-align: center;
            font-size: 12px;
            line-height: 1.2;
            ...
            <div class="content-container">
                ...
                <div class="indented-text">
                    <p>
                        ...
                        <strong>{{ $student['full_name'] }}</strong>, titular {{ $student['type_document_name'] }} N°
