...
Route::get('/images', function () {
   // Ruta a la carpeta 'company_1' dentro de 'storage'
    $companyFolder = storage_path('app/public/company_1/student/');

//
   // Verificamos si la carpeta 'company_1' existe
   if (File::exists($companyFolder)) {
       // Obtener solo las subcarpetas dentro de 'company_1/student'
       $directories = File::directories($companyFolder);
       ...
       foreach ($filteredDirectories as $directory) {
           ...
           if (count($files) > 0) {
               ...
               // Crear la ruta accesible dentro de 'storage' usando el enlace simbólico
